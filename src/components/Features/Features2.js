  ...
  return (
    <section className="bg-white dark:bg-gray-950">
      <div className="container mx-auto flex items-center justify-center px-8 py-20">
        <div
          className={`box-border flex aspect-auto h-full min-h-96 flex-col-reverse items-center justify-between gap-8 overflow-hidden rounded-3xl dark:bg-gray-900 bg-slate-200 bg-opacity-70 md:w-full xl:aspect-[16/5] ${
