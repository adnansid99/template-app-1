export default function Features2({ props }) {
  ...
  return (
    <section className="container mx-auto px-8 py-20 flex items-center justify-center">
      ...
      <div
        className={`flex flex-col-reverse justify-between overflow-hidden lg:aspect-[16/6] xl:aspect-[16/5] items-center gap-8 lg:w-full bg-slate-200 bg-opacity-70 rounded-3xl ${
          isReverse ? "lg:flex-row-reverse" : "lg:flex-row"
        }`}
      >
        <div className="flex pb-10 px-10 lg:p-20 flex-col gap-4 w-full lg:w-1/2 md:gap-8">
          <p className="text-sm -mb-4 text-gray-600 md:text-base">{label}</p>
        ...
        <img
          src={imageSrc}
          alt="features"
          className="w-full lg:w-1/2 aspect-video lg:aspect-auto object-cover object-center"
          loading="lazy"
        />
      </div>
    </section>
